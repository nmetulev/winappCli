...
{
    public string ShortDescription => "Create and modify Package.appxmanifest files";
    ...
    public ManifestCommand(ManifestGenerateCommand manifestGenerateCommand, ManifestUpdateAssetsCommand manifestUpdateAssetsCommand, ManifestAddAliasCommand manifestAddAliasCommand)
        : base("manifest", "Create and modify Package.appxmanifest files for package identity and MSIX packaging. Use 'manifest generate' to create a new manifest, 'manifest update-assets' to regenerate app icons, or 'manifest add-alias' to add an execution alias.")
    {
